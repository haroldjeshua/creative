	...
	return (
		<div className="flex items-center px-4 md:px-0">
			<div className="grid flex-1 gap-2">
				<p>Harv Creative is an independent design studio dedicated to creating visually stunning and functionally effective designs for businesses of all sizes.</p>

				<p>We&apos;re putting the finishing touches on something truly extraordinary. Stay tuned - the unveiling is just around the corner!</p>
